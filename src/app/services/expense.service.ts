...
export class ExpenseService {
  ...
  private expenses: Expense[]=[
    ...
    {name: 'Test2', amount: 10, category: 'test category2', date: new Date (2024,7,9), payment: 'test pay2'},
    {name: 'Test3', amount: 40, category: 'test category3', date: new Date (2024,25,12), payment: 'test pay3'}
  ];
